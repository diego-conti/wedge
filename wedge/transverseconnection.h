 ...
 *                              by Diego Conti, diego.conti@unimib.it      *
 *                                                                         *
...
public:
	TransverseLeviCivitaConnection(const Manifold* manifold, const TransverseRiemannianStructure& _g,const Name& christoffel=N.Gamma) : 
		Connection(manifold,_g.e(),true), PseudoLeviCivitaConnection(manifold, _g, christoffel,true) , g(_g) {}
