...
*/
	PseudoLeviCivitaConnection(const Manifold* manifold, const PseudoRiemannianStructure& structure, const Name& christoffel=N.Gamma, bool assume_orthonormal_coframe=false) :
